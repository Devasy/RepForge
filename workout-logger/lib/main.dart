  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        // ProgramManager handles training programs and enrollments
        ChangeNotifierProvider(
          create: (_) => ProgramManager(_storageService),
        ),
      ],
      child: MaterialApp(
...
class _AppInitializerState extends State<AppInitializer> {
  ...
  Future<void> _initializeApp() async {
    try {
      ...
      // Initialize program manager (storage already initialized above)
      final programManager = context.read<ProgramManager>();
